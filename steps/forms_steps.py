...
def step_verify_form_submission(context):
    ...
    expect(context.page.locator(contact_form.CUSTOMER_PHONE_INPUT)).to_be_visible()
    expect(context.page.locator(contact_form.CUSTOMER_EMAIL_INPUT)).to_be_visible()
    expect(context.page.locator(contact_form.PIZZA_SIZE_SELECT)).to_be_visible()
    expect(context.page.locator(contact_form.TOPPING_CHECKBOX)).to_be_visible()
    expect(context.page.locator(contact_form.COMMENTS_TEXTAREA)).to_be_visible()
    expect(context.page.locator(contact_form.SUBMIT_BUTTON)).to_be_visible()
...
def step_verify_special_chars_handling(context):
    ...
    expect(context.page.locator(contact_form.COMMENTS_TEXTAREA)).to_contain_text("Test with special chars")
